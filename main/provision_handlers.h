...
{
  // Provision page
  httpd_uri_t provision_page_uri = {
      .uri = "/provision",
      .method = HTTP_GET,
  ...
  httpd_uri_t provision_status_uri = {
      .uri = "/api/provision/status",
      .method = HTTP_GET,
  ...
  ESP_LOGI(TAG_PROVISION_HANDLERS, "  GET  /provision             - Provision page");
  ESP_LOGI(TAG_PROVISION_HANDLERS, "  GET  /api/provision/status  - Provision status");
